json.array!(@admin_events) do |admin_event|
  json.extract! admin_event, :id, :client_id, :placeholder_times, :location_id, :bride_first_name, :bride_last_name, :groom_first_name, :groom_last_name, :event_name, :number_of_cameras, :photo_media_id
